...
public class FRAXInstrumentRunnerTest {
  ...
  public void setUp() throws URISyntaxException {
    ...
    fraxInstrumentRunner.setExternalDbName("WinSpiroPRO.wdb");
    fraxInstrumentRunner.setExternalImageName("FVC.jpg");
    fraxInstrumentRunner.setExternalInputName("patient.srv");
    fraxInstrumentRunner.setExternalOutputName("Results.wsp");

    String resourcesParentDir = new File(getClass().getResource("/WinSpiroPRO.wdb").toURI().getPath()).getParent();
    fraxInstrumentRunner.setInitdbPath(new File(resourcesParentDir, File.separator).getPath());
    ...
    fraxInstrumentRunner.setMirPath(winSpiroSimulatedPath);
    ...
    initDbFile = new File(fraxInstrumentRunner.getInitdbPath(), fraxInstrumentRunner.getExternalDbName());
    miniSpirDbFile = new File(fraxInstrumentRunner.getMirPath(), fraxInstrumentRunner.getExternalDbName());
  ...
  public void testInitialize() throws FileNotFoundException, IOException {
    ...
    fraxInstrumentRunner.deleteDeviceData();
    ...
    fraxInstrumentRunner.initParticipantData();
    verify(instrumentExecutionServiceMock);

    // Verify that input file has been created.
    File inputFile = new File(fraxInstrumentRunner.getMirPath() + fraxInstrumentRunner.getExternalInputName());
  ...
  public void testRun() throws FileNotFoundException, IOException, URISyntaxException {
    ...
    FileUtil.copyFile(new File(getClass().getResource("/Results.wsp").toURI()), new File(fraxInstrumentRunner.getMirPath(), fraxInstrumentRunner.getExternalOutputName()));
    FileUtil.copyFile(new File(getClass().getResource("/FVC.jpg").toURI()), new File(fraxInstrumentRunner.getMirPath(), fraxInstrumentRunner.getExternalImageName()));

    // Read the results file.
    LinkedHashMap<String, Double[]> results = fraxInstrumentRunner.retrieveDeviceData(fraxInstrumentRunner.getExternalOutputName());
